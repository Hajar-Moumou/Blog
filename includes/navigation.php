    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item <?php echo $cat_id == $id ? 'active' : '' ?>">
                <a class="nav-link" href="http://localhost/php/blog/blog/categories.php?id=<?php echo $cat_id; ?>">
                    <?php echo $cat_title; ?>
                </a>
            </li>
            <?php 
        ...
        <form class="form-inline my-2 my-lg-0" action="http://localhost/php/blog/blog/search.php" method="POST">
